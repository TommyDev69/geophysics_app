    ...
    <form onSubmit={handleSurveySubmit}>
      ...
      <div className="w-[768px] mx-auto rounded-[10px] px-9 py-6">
        <div className="w-full py-9">
          ...
          />
          <p className="text-red-500 text-[12px]">{error.surveyName}</p>

          {/* Description */}
          <div className="py-9">
            <label className="font-medium text-[14px] text-[#364153] capitalize">Description</label>
            <textarea
              rows="5"
              name="description"
          ...
          <div className="py-3 grid grid-cols-2 gap-8">
            {content.map((item) => (
              ...
              >
                <img src={item.photo} alt={item.topic} />
                <div className="pt-6">
                  <p className="font-medium text-[14px] text-[#364153] capitalize">{item.topic}</p>
                </div>
              </button>
            ))}
          </div>
