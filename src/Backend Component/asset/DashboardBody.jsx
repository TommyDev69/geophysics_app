...
const DashboardBody = () => {
    return ( 
        ...
        <div className="md:w-[967px] ">
            <h1 className="font-instrument md:text-left text-center font-bold md:text-[30px] text-[13px] leading-[36px] tracking-[0.4px] text-[#101828]">Good Morning, Dr. Adebayo 👋</h1> 
        </div>
