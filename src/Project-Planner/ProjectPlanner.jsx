            ...
            <div className=" flex flex-col w-[967px]  mt-[41px] px-12  gap-[22px]">
                ...
                <div className="py-6 rounded-[10px] w-[917px] border text[#FFFFFF] border-[#DADCEO] shadow-[0px_1px_2px_-1px_rgba(0,0,0,0.1),0px_1px_3px_0px_rgba(0,0,0,0.1)]">
                    <div className="flex flex-col w-[768px] mt-[20px] gap-[16px] justify-center">
                        ...
                        <div className="flex flex-col mt-[px] ml-[100px] gap-[16px]">
                            ...
                            <div className="flex flex-col  gap-[8px]">
                                <label className="w-[768px]  mt-[0.5px] font-instrument font-medium text-[14px] leading-[20px] tracking-[-0.15px] text-[#364153]">
                                    Description
                                    <span className="font-instrument font-medium text-[14px] text-[#FF0000] leading-[20px] tracking-[-0.15px]">*</span>
                                </label>
                            ...
                            <div className=" grid grid-cols-2 w-[768px]  gap-[16px]">
                                <div className="">
                            ...
                            <div className="flex flex-col w-[768px] gap-[8px] mt-[0.5px]">
                            ...
                            <div className="flex flex-col  gap-[8px] mt-[0.5px]">
                                ...
                                <select name="" id="" className="w-[768px] py-4 text-[#0A0A0A] rounded-[10px] border border-[#DADCEO] px-[16px] ]">
                                    <option value=""></option>
                                </select>
                            </div>
                            <div className="flex w-[768px] justify-between gap-[12px]">
                                ...
                                <div className="flex items-center gap-2">
                                    <button type="button" onClick={() => {
                                        ...
                                        className=" w-[138px]  py-4 rounded-[10px] border-2 border-[#DADCE0] flex items-center justify-center gap-2 px-2">
                ...
                <div className="flex justify-between  w-[917px]  py-8">
                    <button
                        ...
                        className=" capitalize flex gap-2 border-2 justify-center items-center w-[120px]  px-[15px] rounded-[10px] text-[#364153] font-medium text-[14px]"
                    >
                       <div className="py-2">
                         <img src={left} alt="" />
                       </div>
                    ...
                    <button
                        type="submit"
                        className="flex capitalize gap-2 justeify-center items-center  py-[10px] px-[15px] rounded-[10px] bg-[#364153] text-white font-medium text-[14px]"
                    >
                       <div >
                            <p> create project</p>
                       </div>
